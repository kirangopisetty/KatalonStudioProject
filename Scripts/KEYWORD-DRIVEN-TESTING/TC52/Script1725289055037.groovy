...
WebUI.setText(findTestObject('HEALTHCARE_APP_OR/UN'), varUN)

WebUI.setText(findTestObject('HEALTHCARE_APP_OR/PWD'), varPWD)

WebUI.click(findTestObject('HEALTHCARE_APP_OR/LOGIN_BUTTON'))

WebUI.selectOptionByValue(findTestObject('HEALTHCARE_APP_OR/FACILITY_DROPDOWN'), varFacility, false)

WebUI.check(findTestObject('HEALTHCARE_APP_OR/CHECKBOX'))

WebUI.click(findTestObject('HEALTHCARE_APP_OR/MEDICAID'))

WebUI.setText(findTestObject('HEALTHCARE_APP_OR/VISIT_DATE'), varVisitDate)

WebUI.setText(findTestObject('HEALTHCARE_APP_OR/COMMENT'), varComment)
